...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?= base_url('assets/') ?>/img/search.jpg');">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">You Are Search : <?= $keyword ?></h1>
						</div>
					</div>
					...
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive image_news"
								src="<?= base_url('assets1/img-produk/') ?><?=$d['gambar']?>" alt="">
						</div>
