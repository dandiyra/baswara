...
$(document).ready(function() {
    ...
    function callToaster(positionClass) {
        ...
        if (document.getElementById("toaster")) {
            ...
            // flash login
            if (flashlogin == "Wrong Password") {
                toastr.error("Wrong Password");
            } else if (flashlogin == "Verify") {
                toastr.warning("Verify your email");
            }
            // flash data user
            if (flashdata == "User berhasil ditambahkan") {
                toastr.success("Berhasil menambahkan user baru");
            } else if (flashdata == "Gagal memperbaharui user") {
                toastr.error("User gagal diperbaharui");
            } else if (flashdata == "User berhasil diperbaharui") {
                toastr.success("User berhasil diperbaharui");
            } else if (flashdata == "User berhasil dihapus") {
                toastr.success("User berhasil dihapus");
            }

            // Flash Data Home
            if (flashdata == "Data website berhasil ditambahkan") {
                toastr.success("Data website berhasil ditambahkan");
            } else if (flashdata == "Data website berhasil dirubah") {
                toastr.success("Data website berhasil dirubah");
            } else if (flashdata == "Data Website berhasil dihapus") {
            ...
            } else if (flashdata == "Data produk berhasil dirubah") {
                toastr.success("Data produk berhasil dirubah");
            } else if (flashdata == "Data produk berhasil dihapus") {
                toastr.success("Data produk berhasil dihapus");
            }

            // Flash Data Kategori
            if (flashdata == "Data kategori berhasil ditambahkan") {
                toastr.success("Data kategori berhasil ditambahkan");
            } else if (flashdata == "Data kategori berhasil dirubah") {
                toastr.success("Data kategori berhasil dirubah");
            } else if (flashdata == "Data kategori berhasil dihapus") {
                toastr.success("Data kategori berhasil dihapus");
            }

            // Flash Data News
            if (flashdata == "Berita berhasil ditambahkan") {
                toastr.success("Berita berhasil ditambahkan");
            } else if (flashdata == "Berita berhasil dirubah") {
                toastr.success("Berita berhasil dirubah");
            } else if (flashdata == "Berita berhasil dihapus") {
                toastr.success("Berita berhasil dihapus");
            }

            // Flash Data Akses
            if (flashdata == "Akses berhasil ditambahkan") {
                toastr.success("Akses berhasil ditambahkan");
            } else if (flashdata == "Akses berhasil dirubah") {
                toastr.success("Akses berhasil dirubah");
            }

            // Flash Data HR
            if (flashdata == "Data lowongan berhasil ditambahkan") {
                toastr.success("Data lowongan berhasil ditambahkan");
            } else if (flashdata == "Data lowongan berhasil dirubah") {
